		...
		case 13: {
			...
			if (menu.menu_id == 5) {
				...
				while (1)
				{
					...
					cout << "NGUYEN DUC HUY 		19521620";
					gotoxy(area.getx() + 5, area.gety() + 13);
					cout << "NGUYEN THE DAT 		19521341";
					gotoxy(area.getx() + 5, area.gety() + 14);
					cout << "DOAN KIEN QUOC 		18521700";
					gotoxy(area.getx() + 5, area.gety() + 15);
					cout << "BUI QUAN PHONG 		19522008";
					if (_kbhit())
					{
						break;
					}
